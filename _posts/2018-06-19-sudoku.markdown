...
https://github.com/siahuat0727/sudoku/blob/69f3e69ef1e4fb4d956b009e405cb916059e5c14/sudoku1.c#L85-L95
...
_图中 row 集合表示以 row 的角度来观察可得出之解集合_  
_如 * 位于可由 **cell** 或 **row**、不可由 **col** 或 **box** 观察得出之解集合_  
