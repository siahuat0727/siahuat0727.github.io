...
解数独是刚接触程式时的第一份作业，当时有很多想法但都写不太出来，也找不太到相关想法的实作（大概还不会 google 吧），于是以它作为写 blog 的开始。
这或许不是最好的入门教学但我想应该是最啰嗦的（
另外，非常欢迎路过的有缘人提出建议啦～无论变数命名、设计或是这篇文的定位，任何东西都欢迎提噢！

[Github repo 完整 code](https://github.com/siahuat0727/sudoku)
